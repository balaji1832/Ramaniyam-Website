...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['brand_name'])) {
		...
		foreach($result as $row) {
			$current_color_name = $row['brand_name'];
		}

		$statement = $pdo->prepare("SELECT * FROM tbl_brand  WHERE brand_name=? and brand_name!=?");
    	$statement->execute(array($_POST['brand_name'],$current_color_name));
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="brand_name" value="<?php echo $color_name; ?>">
                    </div>
                </div>
                <div class="form-group">
