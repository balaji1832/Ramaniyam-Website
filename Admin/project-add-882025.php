...
if (isset($_POST['commit'])) {
    ...
    $masterplan_headerimage = uploadFile('masterplan', 'masterplan');
    $Stiltfloor_headerimage = uploadFile('Stiltfloor', 'stiltfloor');
    ...
    $rera_doc = uploadFile('rera_doc', 'rera');
    ...
    if ($row['count'] == 0) {
        $amenities = !empty($_POST['amenities']) ? implode(",", $_POST['amenities']) : '';
          ...
          $sql = "INSERT INTO tbl_projects (
            ...
            meta_title, meta_description, meta_keyword, header_image, card_image,
            ...
            '$overview', '$planning_permit_no', '$planning_permit_date', '$building_permission_no', '$building_permission_date',
            '$tnrera', '$tnrera_date', '$ccertificate', '$ccertificate_date',
            '$meta_title', '$meta_description', '$meta_keyword', '$header_image', '$card_final_name','$pdf_headerimage', '$floorplan',
             '$vicinity', '$locality', '$street', '$tag_line', '$for_sale',
               ...
               <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                ?> </div>
                 ...
                 <div class="row pb-2 px-5 pl-3">
                   ...
                   <div class="col-md-3 mb-3">
                     <label>Planning Permit Doc</label>
                   ...
                   <div class="col-md-3 mb-3">
                     <label>Building Permit Doc</label>
                   ...
                   <div class="col-md-3 mb-3">
                     <label>Completion Certificate Doc</label>
