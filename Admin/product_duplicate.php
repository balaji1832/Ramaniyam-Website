...
$stmt = $pdo->prepare("DELETE FROM tbl_product_duplicate WHERE p_id IN ($placeholders)");
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td><input type="checkbox" class="checkbox" name="ids[]" value="<?php echo htmlentities($row['p_id']);?>"/></td>
