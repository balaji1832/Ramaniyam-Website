    ...
    if(isset($_POST['form_home'])) {
        ...
        $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Home Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
        ...
        if($valid == 1) {
         ...
         $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute About Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
    ...
    if($valid == 1) {
     ...
     $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Team Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
...
if(isset($_POST['form_awards'])) {
    ...
    $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Awards Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
    ...
    if($valid == 1) {
     ...
     $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Ongoing Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
    ...
    if($valid == 1) {
     ...
     $update_success = true;
                ...
                if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute ReadytoOccupy Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
...
if(isset($_POST['form_completed'])) {
    ...
    if($valid == 1) {
     ...
     if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Completed Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
     ...
     if ($update_success) {
                    ...
                    $_SESSION['userid'],
                    $_SESSION['username'],
                    'SEO-Attribute Contactus Page Meta Details updated',
                    'SEO',
                    $last_id,
                    $old_name,
                    $new_name
    ...
    <section class="content-header">
                ...
                $statement = $pdo->prepare("SELECT * FROM tbl_seo");
                $statement->execute();
                $row = $statement->fetch(PDO::FETCH_ASSOC);
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="home_meta_keyword" value="<?php echo $home_meta_keyword; ?>">  
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="home_meta_description" value="<?php echo $home_meta_description; ?>">  
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="about_meta_keyword" value="<?php echo $about_meta_keyword; ?>">  
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="about_meta_description" value="<?php echo $about_meta_description; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="team_meta_keyword" value="<?php echo $team_meta_keyword; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="team_meta_description" value="<?php echo $team_meta_description; ?>"> 
                                                        </div>
                                            ...
                                            <div class="box box-info">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Keyword*</label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control" type="text" name="project_meta_keyword" value="<?php echo $project_meta_keyword; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="project_meta_description" value="<?php echo $project_meta_description; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                            ...
                                            <div class="box box-info">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Keyword*</label>
                                                        <div class="col-sm-8">
                                                        <input class="form-control" type="text" name="awards_meta_keyword" value="<?php echo $awards_meta_keyword; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="awards_meta_description" value="<?php echo $awards_meta_description; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                            ...
                                            <div class="box box-info">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Keyword*</label>
                                                        <div class="col-sm-8">
                                                         <input class="form-control" type="text" name="ongoing_meta_keyword" value="<?php echo $ongoing_meta_keyword; ?>"> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                        <input class="form-control" type="text" name="ongoing_meta_description" value="<?php echo $ongoing_meta_description; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                            ...
                                            <div class="box box-info">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Keyword*</label>
                                                        <div class="col-sm-8">
                                                         <input class="form-control" type="text" name="readytooccupy_meta_keyword" value="<?php echo $readytooccupy_meta_keyword; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="readytooccupy_meta_description" value="<?php echo $readytooccupy_meta_description; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="contact_meta_keyword" value="<?php echo $contact_meta_keyword; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="contact_meta_description" value="<?php echo $contact_meta_description; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="completed_meta_keyword" value="<?php echo $completed_meta_keyword; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label">Meta Description*</label>
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input class="form-control" type="text" name="completed_meta_description" value="<?php echo $completed_meta_description; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-3 control-label"></label>
