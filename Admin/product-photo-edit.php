 ...
 //    }
    ...
    if($valid == 1) {
    	...
    	if($path == '') {
    		...
    		unlink('../assets/uploads/product_photos/'.$_POST['previous_photo']);
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="javascript:history.go(-1)" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
					...
					<div class="box-body">
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-6" style="padding-top:6px;">
				                <img src="../assets/uploads/product_photos/<?php echo $photo; ?>" class="existing-photo" style="width:300px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								&nbsp; <a href="product-edit.php?id=<?php echo $_REQUEST['id1']  ?>">Back to page </a>
							</div>
						</div>
					</div>
				</div>
