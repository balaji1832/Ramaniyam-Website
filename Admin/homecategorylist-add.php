...
// 		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'tbl_brand_category'");
// 		$statement->execute();
...
// 		}
		...
		$final_name = 'homecategoryfilter-'.$ai_id.'.'.$ext;
		...
		$statement = $pdo->prepare("INSERT INTO tbl_brand_category (photo,cat_id,button_url,p_is_active) VALUES (?,?,?,?)");
		$statement->execute(array($final_name,$_POST['cat_id'],$_POST['button_url'],$_POST['p_is_active']));
		

			
		$success_message = 'Home Category Brand Filter is added successfully!';
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Home Our Category Filter </h1>
	</div>
				...
				<div class="box box-info">
					<div class="box-body">
                     	...
                     	<div class="form-group">
							<label for="" class="col-sm-2 control-label"> Our Brand <span>*</span></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="content" value="<?php if(isset($_POST['content'])){echo $_POST['content'];} ?>">
							</div>
						</div>
						<div class="form-group">
