    ...
    if($valid == 1) {
        ...
        if($path == '') {
        	...
        	$statement->execute(array(
        							...
        							$_POST['p_is_featured'],
        							$_POST['p_is_newarrival'],
        							$_POST['p_is_bestsellers'],
        							$_POST['p_is_active'],
        							$_POST['tcat_id'],
        							$_POST['mcat_id'],
        							$_POST['ecat_id'],
...
foreach ($result as $row) {
	...
	$p_is_newarrival = $row['p_is_newarrivals'];
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">MRP Price<br><span style="font-size:10px;font-weight:normal;">(In INR)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Discount Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In INR)</span></label>
							<div class="col-sm-4">
							...
							<div class="col-sm-4">
								...
								<option value="">Select Brand </option>
									...
									foreach ($result as $row) {
										...
										?>
										<option value="<?php echo $row['brand_id']; ?>" <?php if($row['brand_id'] == $p_brand){echo 'selected';} ?> ><?php echo $row['brand_name']; ?></option>
										<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Is Best sellers ?</label>
							<div class="col-sm-8">
								<select name="p_is_bestsellers" class="form-control" style="width:auto;">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select name="p_is_newarrival" class="form-control" style="width:auto;">
									<option value="0" <?php if($p_is_newarrival == '0'){echo 'selected';} ?>>No</option>
									<option value="1" <?php if($p_is_newarrival== '1'){echo 'selected';} ?>>Yes</option>
								</select> 
							</div>
						</div>
						<div class="form-group">
