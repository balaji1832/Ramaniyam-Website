  ...
  <div class="container">
      ...
      <li><a href="Allprojects" class="text-dark text-decoration-none d-block p-3">All Projects</a></li>
    </ul>
  </div>
</div>
      ...
      <ul class="list-unstyled d-flex justify-content-evenly px-0 mb-0 text-uppercase">
        ...
        <li><a href="#" class="text-dark text-decoration-none d-block p-3">Awards</a></li>
          ...
          <li class="nav-item d-flex align-items-center">
            ...
            <a href="Seniorliving" class="text-decoration-none text-dark ms-2" style="font-weight: 500;">SENIOR LIVING</a>
          </li>
        ...
        <div class="accordion" id="mobileMenuAccordion">
            ...
            <div id="collapseProjects" class="accordion-collapse collapse" data-bs-parent="#mobileMenuAccordion">
              <div class="accordion-body">
                <ul class="list-unstyled text-uppercase">
                  ...
                  <li><a href="Allprojects" class="text-dark text-decoration-none d-block py-1">All Projects</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <div class="accordion-header px-3 py-2 d-flex align-items-center">
              ...
              <span class="SENIOR-LIVING fw-semibold"><a href="Seniorliving" class="text-decoration-none text-dark">SENIOR LIVING</a></span>
            </div>
          </div>
